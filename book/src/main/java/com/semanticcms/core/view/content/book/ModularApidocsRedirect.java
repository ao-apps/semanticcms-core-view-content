...
package com.semanticcms.core.view.content.book;
...
@WebServlet("/core/view-content/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/core/view-content/apidocs/com.semanticcms.core.view.content/com" + Objects.toString(req.getPathInfo(), ""),
